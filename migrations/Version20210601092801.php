 ...
 */
final class Version20210601092801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, reduction LONGTEXT DEFAULT NULL, date_paiement DATE DEFAULT NULL, date_expedition DATE DEFAULT NULL, commande_annule TINYINT(1) NOT NULL, frais_de_port DOUBLE PRECISION NOT NULL, prix_total DOUBLE PRECISION NOT NULL, id_client INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
