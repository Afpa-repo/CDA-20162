...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\CatalogueProduitController' => 'getCatalogueProduitControllerService',
    ...
    /**
     * Gets the public 'App\Controller\CatalogueProduitController' shared autowired service.
     *
     * @return \App\Controller\CatalogueProduitController
     */
    protected function getCatalogueProduitControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'CatalogueProduitController.php';

        $this->services['App\\Controller\\CatalogueProduitController'] = $instance = new \App\Controller\CatalogueProduitController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\CatalogueProduitController', $this));
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'ProduitsFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ProduitsFixtures(), 'groups' => []]]);
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder03275 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer920e8 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesaaa57 = [
        
    ];

    public function getConnection()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getConnection', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getMetadataFactory', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getExpressionBuilder', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'beginTransaction', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getCache', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getCache();
    }

    public function transactional($func)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'transactional', array('func' => $func), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->transactional($func);
    }

    public function commit()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'commit', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->commit();
    }

    public function rollback()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'rollback', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getClassMetadata', array('className' => $className), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'createQuery', array('dql' => $dql), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'createNamedQuery', array('name' => $name), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'createQueryBuilder', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'flush', array('entity' => $entity), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'clear', array('entityName' => $entityName), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->clear($entityName);
    }

    public function close()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'close', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->close();
    }

    public function persist($entity)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'persist', array('entity' => $entity), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'remove', array('entity' => $entity), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'refresh', array('entity' => $entity), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'detach', array('entity' => $entity), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'merge', array('entity' => $entity), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getRepository', array('entityName' => $entityName), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'contains', array('entity' => $entity), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getEventManager', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getConfiguration', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'isOpen', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getUnitOfWork', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getProxyFactory', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'initializeObject', array('obj' => $obj), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'getFilters', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'isFiltersStateClean', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'hasFilters', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return $this->valueHolder03275->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer920e8 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder03275) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder03275 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder03275->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, '__get', ['name' => $name], $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        if (isset(self::$publicPropertiesaaa57[$name])) {
            return $this->valueHolder03275->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder03275;
    ...
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;
    ...
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, '__isset', array('name' => $name), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;
    ...
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, '__unset', array('name' => $name), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;
    ...
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, '__clone', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        $this->valueHolder03275 = clone $this->valueHolder03275;
    }

    public function __sleep()
    {
        $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, '__sleep', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;

        return array('valueHolder03275');
    }
    ...
    {
        $this->initializer920e8 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer920e8;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer920e8 && ($this->initializer920e8->__invoke($valueHolder03275, $this, 'initializeProxy', array(), $this->initializer920e8) || 1) && $this->valueHolder03275 = $valueHolder03275;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder03275;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder03275;
    }
}
